...
const about = {
  ...
  info: [
    ...
    {
      fieldName: "Email",
      fieldValue: "Nissho.01@gmail.com",
    },
    {
      fieldName: "Feelance",
...
const experience = {
  ...
  items:[
    ...
    },
    {
      ...
      position: "Freelandce Web Developer",
      duration: "2020 - 2022",
    },
    {
...
const Resume = () => {
    return (
      <motion.div
        initial={{opacity: 0}}
        animate={{
          opacity:1, transition: {delay:0.4, duration: 0.4, ease: "easeIn"},
      }}
